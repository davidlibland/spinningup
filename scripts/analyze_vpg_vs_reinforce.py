"""Compare vpg.py against reinforce.py on CartPole-v1.

Produces:
  - scripts/vpg_vs_reinforce_results.png
  - scripts/vpg_vs_reinforce_summary.md
"""
...
RUNS_DIR = REPO / "runs"
OUT_PNG = REPO / "scripts" / "vpg_vs_reinforce_results.png"
OUT_MD = REPO / "scripts" / "vpg_vs_reinforce_summary.md"
...
COLOR = {"reinforce": "#d62728", "vpg": "#9467bd"}
LABEL = {"reinforce": "REINFORCE", "vpg": "VPG"}
...
def main() -> None:
    ...
    ax.set_title("CartPole-v1: VPG vs REINFORCE (mean +/- std across 5 seeds)")
    ...
    lines: list[str] = []
    lines.append("# VPG vs REINFORCE on CartPole-v1\n")
