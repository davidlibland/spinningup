...
# ///
"""Statistical analysis of LunarLander PPO runs across learning rates and seeds.
...
def main() -> None:
    ...
    ax.set_title("LunarLander-v3 / PPO — learning curves (95% bootstrap CI over seeds)")
